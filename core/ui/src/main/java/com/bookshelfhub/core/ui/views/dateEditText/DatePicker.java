...
public class DatePicker extends RelativeLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            editDatePickerReal.setOnFocusChangeListener((v, hasFocus) -> {
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_date_picker_on_focus).setOnClickListener(v -> showKeyboard(editDatePickerReal, getContext()));
    }
