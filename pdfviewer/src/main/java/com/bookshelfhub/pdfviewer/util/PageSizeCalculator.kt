...
class PageSizeCalculator(
    private val fitPolicy: FitPolicy?, private val originalMaxWidthPageSize: Size?, private val originalMaxHeightPageSize: Size?,
    private val viewSize: Size?, private val fitEachPage: Boolean = false) {
