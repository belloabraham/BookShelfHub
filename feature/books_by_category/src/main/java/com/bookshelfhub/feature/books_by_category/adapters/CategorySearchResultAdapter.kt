...
class CategorySearchResultAdapter (private val context:Context) {
    ...
    fun getSearchResultAdapter(): ListAdapter<Any, RecyclerViewHolder<Any>> {
        return adapterOf {
            ...
            register(
                ...
                viewHolder = CategorySearchResultAdapter::SearchResultViewHolder,
                onBindViewHolder = { vh, _, model ->
                    vh.bindToView(model, context, this@CategorySearchResultAdapter)
                }
            )
    ...
    private class SearchResultViewHolder(view: View) : RecyclerViewHolder<PublishedBookUiState>(view) {
        ...
        fun bindToView(model: PublishedBookUiState, context: Context, storeSearchResultAdapter: CategorySearchResultAdapter){
