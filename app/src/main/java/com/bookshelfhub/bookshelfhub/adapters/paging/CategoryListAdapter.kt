...
class CategoryListAdapter(private val activity: Activity, diffCallBack:DiffUtil.ItemCallback<PublishedBooks>): PagingDataAdapter<PublishedBooks, CategoryListAdapter.ViewHolder>(diffCallBack){
