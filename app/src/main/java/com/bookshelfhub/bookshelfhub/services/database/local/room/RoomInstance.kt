...
@Database(entities = [UserRecord::class, PaymentInfoRecord::class, BooksOrderedRecord::class, BookInterestRecord::class, StoreSearchHistory::class, ShelfSearchHistory::class], version = 1, exportSchema = false)
