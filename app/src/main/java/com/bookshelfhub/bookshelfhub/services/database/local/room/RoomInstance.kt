...
@Database(entities = [User::class, PaymentInfo::class, OrderedBooks::class, BookInterest::class, StoreSearchHistory::class, ShelfSearchHistory::class, PubReferrers::class,], version = 1, exportSchema = false)
