...
@Database(entities = [User::class, PaymentInfo::class, OrderedBooks::class, BookInterest::class, StoreSearchResult::class, ShelfSearchResult::class, PubReferrers::class,], version = 1, exportSchema = false)
