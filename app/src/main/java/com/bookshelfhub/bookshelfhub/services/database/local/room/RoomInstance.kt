...
@Database(entities = [UserRecord::class, PaymentInfoRecord::class, BooksOrderedRecord::class, BookInterestRecord::class, CloudSearchHistory::class, LocalSearchHistory::class], version = 1, exportSchema = false)
