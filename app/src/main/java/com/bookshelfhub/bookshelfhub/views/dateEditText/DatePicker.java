package com.bookshelfhub.bookshelfhub.views.dateEditText;
...
public class DatePicker extends RelativeLayout {
    ...
    private EditText editDatePickerReal;
    private LinearLayout layoutDatePicker;
    private TextView textDatePickerDate;
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.DatePicker,
                defStyleAttr, 0);
        textColor = attributes.getColor(R.styleable.DatePicker_dp_text_color, Color.BLACK);
        hintColor = attributes.getColor(R.styleable.DatePicker_dp_hint_color, Color.GRAY);
        showFullDate = attributes.getBoolean(R.styleable.DatePicker_dp_show_full_date, true);

        int dateFormatValue = attributes.getInteger(R.styleable.DatePicker_dp_date_format,
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
                ...
                addKeyboardVisibilityListener(this, new OnKeyboardVisibilityListener() {
                    ...
                    public void onVisibilityChange(boolean isVisible) {
                        if (keyboardVisible != isVisible) {
                            ...
                            if (!keyboardVisible && editDatePickerReal.isFocused()) {
                                editDatePickerReal.clearFocus();
                            }
                        }
                    }
                });
            ...
            editDatePickerReal.setOnFocusChangeListener(new OnFocusChangeListener() {
                @Override
    ...
    private void initView() {
        ...
        editDatePickerReal = findViewById(R.id.edit_date_picker_real);
        layoutDatePicker = findViewById(R.id.layout_date_picker);
        textDatePickerDate = findViewById(R.id.text_date_picker_date);

        textLazyDate1 = findViewById(R.id.text_date_1);
        viewLazyDate1 = findViewById(R.id.view_date_1);
        textLazyDate2 = findViewById(R.id.text_date_2);
        viewLazyDate2 = findViewById(R.id.view_date_2);
        textLazyDate3 = findViewById(R.id.text_date_3);
        viewLazyDate3 = findViewById(R.id.view_date_3);
        textLazyDate4 = findViewById(R.id.text_date_4);
        viewLazyDate4 = findViewById(R.id.view_date_4);
        textLazyDate5 = findViewById(R.id.text_date_5);
        viewLazyDate5 = findViewById(R.id.view_date_5);
        textLazyDate6 = findViewById(R.id.text_date_6);
        viewLazyDate6 = findViewById(R.id.view_date_6);
        textLazyDate7 = findViewById(R.id.text_date_7);
        viewLazyDate7 = findViewById(R.id.view_date_7);
        textLazyDate8 = findViewById(R.id.text_date_8);
        viewLazyDate8 = findViewById(R.id.view_date_8);
      ...
      //  viewLazyDate7.setVisibility(View.GONE);
       ...
       // viewLazyDate8.setVisibility(View.GONE);
        ...
        if (dateFormat == DateFormat.MM_DD_YYYY) {
            textLazyDate1.setText(getContext().getString(R.string.dp_month));
            textLazyDate2.setText(getContext().getString(R.string.dp_month));
            textLazyDate3.setText(getContext().getString(R.string.dp_day));
            textLazyDate4.setText(getContext().getString(R.string.dp_day));
        } else if (dateFormat == DateFormat.DD_MM_YYYY) {
            textLazyDate1.setText(getContext().getString(R.string.dp_day));
            textLazyDate2.setText(getContext().getString(R.string.dp_day));
            textLazyDate3.setText(getContext().getString(R.string.dp_month));
            textLazyDate4.setText(getContext().getString(R.string.dp_month));
        }

        textLazyDate5.setText(getContext().getString(R.string.dp_year));
        textLazyDate6.setText(getContext().getString(R.string.dp_year));
        textLazyDate7.setText(getContext().getString(R.string.dp_year));
        textLazyDate8.setText(getContext().getString(R.string.dp_year));

        textDatePickerDate.setTextColor(textColor);

        findViewById(R.id.btn_date_picker_on_focus).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showKeyboard(editDatePickerReal, getContext());
            }
        });
    }
    ...
    private void showFullDateLayout(boolean hasFocus) {
        if (!hasFocus && date.length() == LENGTH_DATE_COMPLETE) {
            ...
            textDatePickerDate.setVisibility(View.GONE);
        }
    }
        ...
        switch (value.length()) {
            case 0:
                textLazyDate1.setText(getContext().getString(dateFormat == DateFormat.MM_DD_YYYY
                        ? R.string.dp_month : R.string.dp_day));
                textLazyDate1.setTextColor(hintColor);
                break;
            case 1:
            ...
            case 2:
                ...
                textLazyDate3.setText(getContext().getString(dateFormat == DateFormat.MM_DD_YYYY
                        ? R.string.dp_day : R.string.dp_month));
                textLazyDate3.setTextColor(hintColor);
                break;
            case 3:
    ...
    protected void fillDate() {
        detachTextWatcher();
        editDatePickerReal.setText(date);
        initTextWatcher();
        ...
        if (showFullDate) {
            showFullDateLayout(editDatePickerReal.isFocused());
        }
    }
    //endregion
    ...
    private void detachTextWatcher() {
        editDatePickerReal.removeTextChangedListener(textWatcher);
        textWatcher = null;
    }
    ...
    private void initTextWatcher() {
        if (textWatcher == null) {
            ...
            editDatePickerReal.addTextChangedListener(textWatcher);
        }
    }
    //endregion
